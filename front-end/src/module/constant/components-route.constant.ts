...
import { RouterPath, RouterPathType, RouterConfig } from '../model/client/route-path';

export const COMPONENTS_ROUTE_CONSTANT: Array<RouterConfig> = [
    ...
    { menu: false, type: RouterPathType.add, path: RouterPath.USUARIO_ADD, name: RouterPath.USUARIO_ADD, component: UsuarioManagementComponent, alias: 'Usuário' },
    ...
    { menu: false, type: RouterPathType.add, path: RouterPath.CURSO_ADD, name: RouterPath.CURSO_ADD, component: CursoManagementComponent, alias: 'Curso' },
    ...
    { menu: false, type: RouterPathType.add, path: RouterPath.MATERIA_ADD, name: RouterPath.MATERIA_ADD, component: MateriaManagementComponent, alias: 'Materia' },
    ...
    { menu: false, type: RouterPathType.add, path: RouterPath.INSTITUICAO_ADD, name: RouterPath.INSTITUICAO_ADD, component: InstituicaoManagementComponent, alias: 'Instituição' },
    ...
    { menu: false, type: RouterPathType.add, path: RouterPath.INSTITUICAO_CATEGORIA_ADD, name: RouterPath.INSTITUICAO_CATEGORIA_ADD, component: InstituicaoCategoriaManagementComponent, alias: 'Categoria' },
    ...
    { menu: false, type: RouterPathType.add, path: RouterPath.CATEGORIA_PROFISSIONAL_ADD, name: RouterPath.CATEGORIA_PROFISSIONAL_ADD, component: CategoriaProfissionalManagementComponent, alias: 'CategoriaProfissional' },
